...
EOD;
	$slack_body = "Name: *".addslashes($name)."*\nEmail: $email\nPhone: *".addslashes($phone)."*\nMessage: ".addslashes($message);
...
//Must end on first column
	...
	system("curl -X POST -H 'Content-type: application/json' --data '{\"attachments\": [ { \"title\": \"\", \"pretext\": \"From https://javascriptlabs.com\", \"text\": \"$slack_body\", \"mrkdwn_in\": [ \"text\", \"pretext\" ] } ] }' ".$_ENV['JL_SLACK_WH']);

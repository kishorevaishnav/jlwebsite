...
//Must end on first column
	...
	system("curl -X POST -H 'Content-type: application/json' --data '{\"attachments\": [ { \"title\": \"From *https://javascriptlabs.com*\", \"pretext\": \"\", \"text\": \"$slack_body\", \"mrkdwn_in\": [ \"text\", \"pretext\" ] } ] }' ".$_ENV['JL_SLACK_WH']);
